...
__CHANNEL_USERNAME__ = "YT CAT × RMSTUDIO"
__GROUP_USERNAME__   = "Car parking 外掛討論群 & CPM 工具 聊天室"
...
def banner(console):
    ...
    brand_name =  "Car Parking Multiplayer 1 Tool - https://t.me/+iB8B6GQx0k4yNDk1"
    colors = [
